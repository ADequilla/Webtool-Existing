...
<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btn-reset").click(function(){
				$('#bankCode').val($('#default_bankCode').val());
				$('#bankName').val($('#default_bankName').val());
				$('#shortName').val($('#default_shortName').val());
            	$('#bankBic').val($('#default_bankBic').val());
			});
	...
	<div class="content">
		...
		<div class="main-content">
			<form class="form-horizontal" role="form"
				...
				<input type="hidden" id="id" name="id" value="${bankList.id}">
				<input type="hidden" id="default_bankCode" value="${bankList.bankCode}">
				<input type="hidden" id="default_bankName" value="${bankList.bankName}">
				<input type="hidden" id="default_shortName" value="${bankList.shortName}">
				<input type="hidden" id="default_bankBic" value="${bankList.bankBic}">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="bankCode" name="bankCode"
											value="${bankList.bankCode}" type="number"
