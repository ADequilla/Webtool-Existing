...
<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btn-reset").click(function(){
				...
				$('#loadProductId').val($('#default_loadProductId').val());
				$('#loadProductName').val($('#default_loadProductName').val());
	...
	<div class="content">
		...
		<div class="main-content">
			<form class="form-horizontal" role="form"
				...
				<input type="hidden" id="default_productCategoryId" value="${loadProduct.productCategoryId}"> 
				<input type="hidden" id="default_loadProductId" value="${loadProduct.loadProductId}">
				<input type="hidden" id="default_loadProductName" value="${loadProduct.loadProductName}">
				<input type="hidden" id="default_description" value="${loadProduct.description}">
				<input type="hidden" id="default_status" value="${loadProduct.status}">
