...
<html>
<head>
<title>Unit | Utilities</title>
<script type="text/javascript">
		$(document).ready(function() {
	    	var oTable = $("#dataTable").dataTable({
	        	"sAjaxSource"	: "${pageContext.request.contextPath}/utilities/unit/search",
	            "sServerMethod"	: "POST",
			...
			$("#btn-delete").click(function(){
	            ...
	            if(data.length > 0){
	    			submit('/utilities/unit/delete', JSON.stringify(data), function (data) {
	    				oTable.fnDraw();
	    			});
	           	} else {
...
<body>
	...
	<div class="content">
		<div class="row">
			<div class="col-lg-5 ">
				<div class="main-header">
					...
					<h3>
						<i class="fa fa-sitemap fa-fw"></i> Unit
					</h3>
					<em>Utilities</em>
				</div>
			</div>
			<div class="col-lg-7 ">
				<div class="top-content">
					<ul class="list-inline quick-access">
						<li><a
							href="${pageContext.request.contextPath}/utilities/unit/create">
		...
		<div class="widget widget-table">
			<div class="widget-header">
				<h3>
					<i class="fa fa-table"></i> Unit List
				</h3>
			</div>
