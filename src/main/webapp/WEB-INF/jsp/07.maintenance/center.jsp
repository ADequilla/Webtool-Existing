...
<html>
<head>
<title>Center | Utilities</title>
<script type="text/javascript">
		$(document).ready(function() {
	    	var oTable = $("#dataTable").dataTable({
	        	"sAjaxSource"	: "${pageContext.request.contextPath}/utilities/center/search",
	            "sServerMethod"	: "POST",
			...
			$("#btn-delete").click(function(){
	            ...
	            if(data.length > 0){
	    			submit('/utilities/center/delete', JSON.stringify(data), function (data) {
	    				oTable.fnDraw();
	    			});
	           	} else {
...
<body>
	...
	<div class="content">
		<div class="row">
			<div class="col-lg-5 ">
				<div class="main-header">
					...
					<h3>
						<i class="fa fa-sitemap fa-fw"></i> Center
					</h3>
					<em>Utilities</em>
				</div>
			</div>
			<div class="col-lg-7 ">
				<div class="top-content">
					<ul class="list-inline quick-access">
						<li><a
							href="${pageContext.request.contextPath}/utilities/center/create">
								<div class="quick-access-item bg-color-blue">
									<i class="fa fa-plus"></i>
									<h5>New Center</h5>
									<em>add new center</em>
								</div>
						</a></li>
					</ul>
				</div>
		...
		<div class="widget widget-table">
			<div class="widget-header">
				<h3>
					<i class="fa fa-table"></i> Center List
				</h3>
			</div>
