...
<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btn-reset").click(function(){
				$('#partnerId').val($('#default_partnerId').val());
				$('#partnerName').val($('#default_partnerName').val());
				$('#partnerDesc').val($('#default_partnerDesc').val());
            	$('#partnerAccount').val($('#default_partnerAccount').val());
				$('#partnerApiUrl').val($('#default_partnerApiUrl').val());
				$('#mriGroup').val($('#default_mriGroup').val());
				$('#merchantUrl').val($('#default_merchantUrl').val());
            	$('#merchantPrefix').val($('#default_merchantPrefix').val());
	...
	<div class="content">
		...
		<div class="main-content">
			<form class="form-horizontal" role="form"
				...
				<input type="hidden" id="default_partnerId" value="${partner.partnerId}">
				<input type="hidden" id="default_partnerName" value="${partner.partnerName}">
				<input type="hidden" id="default_partnerDesc" value="${partner.partnerDesc}">
				<input type="hidden" id="default_partnerAccount" value="${partner.partnerAccount}">
				<input type="hidden" id="default_partnerApiUrl" value="${partner.partnerApiUrl}">
				<input type="hidden" id="default_mriGroup" value="${partner.mriGroup}">
				<input type="hidden" id="default_merchantUrl" value="${partner.merchantUrl}">
				<input type="hidden" id="default_merchantPrefix" value="${partner.merchantPrefix}">
				<input type="hidden" id="default_status" value="${partner.status}">
