...
<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btn-reset").click(function(){
            	...
            	$('#productCategoryName').val($('#default_productCategoryName').val());
	...
	<div class="content">
		...
		<div class="main-content">
			<form class="form-horizontal" role="form"
				...
				<input type="hidden" id="default_productTypeId" value="${productCategory.productTypeId}">
				<input type="hidden" id="default_productCategoryId" value="${productCategory.productCategoryId}"> 
				<input type="hidden" id="default_productCategoryName" value="${productCategory.productCategoryName}"> 
				<input type="hidden" id="default_status" value="${productCategory.status}">
