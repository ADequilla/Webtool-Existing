...
<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btn-reset").click(function(){
				...
				$('#commissionType').val($('#default_commissionType').val());
				$('#customerIncome').val($('#default_customerIncome').val());
            	$('#bankIncome').val($('#default_bankIncome').val());
				$('#agentIncome').val($('#default_agentIncome').val());
				$('#bankPartnerIncome').val($('#default_bankPartnerIncome').val());
			});
        });
	...
	<div class="content">
		...
		<div class="main-content">
			<form class="form-horizontal" role="form"
				...
				<input type="hidden" id="default_transType" value="${commissionSetup.transType}"> 
				<input type="hidden" id="default_commissionType" value="${commissionSetup.commissionType}">
				<input type="hidden" id="default_customerIncome" value="${commissionSetup.customerIncome}">
				<input type="hidden" id="default_bankIncome" value="${commissionSetup.bankIncome}">
				<input type="hidden" id="default_agentIncome" value="${commissionSetup.agentIncome}">
				<input type="hidden" id="default_bankPartnerIncome" value="${commissionSetup.bankPartnerIncome}">
