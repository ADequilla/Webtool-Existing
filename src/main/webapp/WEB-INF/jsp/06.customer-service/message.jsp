...
<html>
<head>
<title>Broadcast Message | Customer Service</title>
<script type="text/javascript">
		$(document).ready(function() {
	    	var oTable = $("#dataTable").dataTable({
	        	"sAjaxSource"	: "${pageContext.request.contextPath}/cs/message/search",
	            "sServerMethod"	: "POST",
	            "fnServerData"	: function (sSource, aoData, fnCallback) {
	            	var subject	= $.trim($("#searchSubject").val());
    ...
    if (data.length > 0) {
        submit('/cs/message/delete', JSON.stringify(data), function (data) {
            oTable.fnDraw();
        }, function (error) {
...
<body>
	...
	<div class="content">
			...
			<div class="col-lg-5 ">
				<div class="main-header">
					<ul class="breadcrumb">
						...
						<li class="active"><a
							href="${pageContext.request.contextPath}/cs/message/">Broadcast
								Message</a></li>
					</ul>
					<h3>
			...
			<div class="col-lg-7 ">
				<div class="top-content">
					<ul class="list-inline quick-access">
						<li><a
							href="${pageContext.request.contextPath}/cs/message/create">
								<div class="quick-access-item bg-color-blue">
									<i class="fa fa-plus"></i>
									<h5>New Broadcast Message</h5>
									<em>add new Broadcast Message</em>
								</div>
						</a></li>
					</ul>
				</div>
		...
		<div class="widget widget-table">
			<div class="widget-header">
				<h3>
					<i class="fa fa-table"></i> Broadcast Message List
				</h3>
			</div>
