...
<html>
<head>
<title>CSR Hotline | Create</title>
	...
	<div class="content">
		<div class="row">
			<div class="col-lg-6 ">
				<div class="main-header">
					...
					<h3>
						<i class="fa fa-plus"></i> Create CSR Hotline
					</h3>
		...
		<div class="main-content">
			<form class="form-horizontal" role="form"
				...
				<input type="hidden" id="default_institution"
					value="${CSRHotline.institutionCode}">
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-header">
								<h3>
									<i class="fa fa-sitemap fa-fw"></i> Create CSR Hotline
								</h3>
							</div>
