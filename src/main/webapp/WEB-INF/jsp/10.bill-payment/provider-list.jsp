			...
			<div class="col-lg-5 ">
				<div class="main-header">
					<ul class="breadcrumb">
						...
						<li>Bill Payment</li>
						<li class="active"><a
							href="${pageContext.request.contextPath}/monitoring/bill-payment-provider/">List</a></li>
					</ul>
					<h3>
			...
			<div class="col-lg-7 ">
				<div class="top-content">
					<ul class="list-inline quick-access">
						<li><a
							href="${pageContext.request.contextPath}/monitoring/bill-payment-provider/create">
								<div class="quick-access-item bg-color-blue">
									<i class="fa fa-plus"></i>
									<h5>Provider</h5>
									<em>add new provider data</em>
								</div>
						</a></li>
					</ul>
				</div>
