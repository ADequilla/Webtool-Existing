...
<html>
<head>
<title>Active Client | Dashboard</title>
	    ...
	    <div class="col-lg-5 ">
	       	<div class="main-header">
		        <ul class="breadcrumb">
		            ...
		            <li>Dashboard</li>
		            <li class="active"><a href="${pageContext.request.contextPath}/dashboard/active-client/">Active Client</a></li>
		        </ul>
		        <h3>
		           <i class="fa fa-cube"></i> Active Client
		       	</h3><em>Dashboard</em>
	    	</div>
	    </div>
	</div>
    ...
    <div class="main-content">
        ...
        <div class="widget widget-table">
            <div class="widget-header">
                <h3><i class="fa fa-table"></i>Active Client</h3>
            </div>
            <div class="widget-content" style="padding:0px;">
				<div id="reportActiveClient">
					<iframe width="100%" height="800" src="${ACTIVE_CLIENT_REPORT}" frameborder="0" style="border:0" allowfullscreen></iframe>
				</div>
            </div>
        </div>
