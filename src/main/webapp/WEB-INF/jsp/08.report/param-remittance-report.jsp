							...
							<div class="form-body">
								<div class="form-body">
									<div class="form-group">
										...
										<label class="col-md-2 control-label">Source Branch</label>
										<div class="col-sm-4">
											<input type="hidden" id="sourceBranch" name="sourceBranch">
											<div class="input-group">
												<input id="sourceBranchD" name="sourceBranchD" type="text"
													style="cursor: pointer;"
													class="form-control showSourceBranchPopup"
													readonly="readonly" placeholder="Source Branch" /> <span
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="hidden" id="targetBranch" name="targetBranch">
											<div class="input-group">
												<input id="targetBranchD" name="targetBranchD" type="text"
													style="cursor: pointer;"
													class="form-control showTargetBranchPopup"
													readonly="readonly" placeholder="Target Branch" /> <span
													class="input-group-addon"><i class="fa fa-search"></i></span>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-md-2 control-label">Transaction
											Status</label>
										<div class="col-sm-4">
