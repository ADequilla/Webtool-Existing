							...
							<div class="form-body">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<label class="col-md-2 control-label">Trans Filter <span
											class="required">*</span></label>
										<div class="col-sm-4">
											<select id="transFilter" name="transFilter" class="form-control required">
												<option value="">-- Transaction Filter --</option>
												<option value="1">Reversal</option>
												<option value="2">No Reversal</option>
