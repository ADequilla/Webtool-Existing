							...
							<div class="form-body">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<label class="col-md-2 control-label">Type of Modif </label>
										<div class="col-sm-4">
											<select id="modifType" name="modifType" class="form-control">
												<option value="">-- Type of Modif --</option>
												<c:forEach items="${listModifType}" var="lookup">
													<option value="${lookup.value}">${lookup.description}</option>
												</c:forEach>
											</select>
										</div>
