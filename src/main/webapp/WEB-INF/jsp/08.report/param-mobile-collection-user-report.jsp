								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<div class="input-group">
												<input id="unitDesc" name="unitDesc" type="text"
													style="cursor: pointer;" class="form-control showUnitPopup"
													readonly="readonly" placeholder="Unit Code" /> <span
													class="input-group-addon"><i class="fa fa-search"></i></span>
											</div>
										</div>
									</div>
