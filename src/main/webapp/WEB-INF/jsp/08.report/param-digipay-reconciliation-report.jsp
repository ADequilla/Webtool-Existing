						...
						<div class="widget-content form">
							<div class="form-body">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select id="category" name="category" class="form-control">
												...
												<c:forEach items="${listCategory}" var="category">
													<option value="${category.productCategoryName}">${category.productCategoryName}</option>
												</c:forEach>
											</select>
										</div>
										...
										<div class="col-sm-4">
											<select id="product" name="product" class="form-control">
												...
												<c:forEach items="${listBillerProduct}" var="billerProduct">
													<option value="${billerProduct.billerProductName}">${billerProduct.billerProductName}</option>
												</c:forEach>
												<c:forEach items="${listLoadProduct}" var="loadProduct">
													<option value="${loadProduct.loadProductName}">${loadProduct.loadProductName}</option>
												</c:forEach>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-md-2 control-label">Core Ref ID
											Total Cost </label>
										<div class="col-sm-4">
											<input id="coreRefIdTotalCost" name="coreRefIdTotalCost"
												type="text" class="form-control"
												placeholder="Core Ref ID Total Cost" />
										</div>
										<label class="col-md-2 control-label">Core Ref ID
											Income </label>
										<div class="col-sm-4">
											<input id="coreRefIdIncome" name="coreRefIdIncome"
												type="text" class="form-control"
												placeholder="Core Ref ID Income" />
										</div>
									</div>
