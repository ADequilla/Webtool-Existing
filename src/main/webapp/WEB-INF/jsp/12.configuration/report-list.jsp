...
<script type="text/javascript">
        $(document).ready(function() {
            var oTable = $("#dataTable").dataTable({
                "sAjaxSource": "${pageContext.request.contextPath}/report/${REPORT_MENU}/search",
                "sServerMethod": "POST",
                "scrollX"		: true,
		...
		<div class="row">
			<div class="col-lg-8 ">
				<div class="main-header">
					...
					<h3>
						<i class="fa fa-clone"></i> Transaction
					</h3>
					<em>Report</em>
				</div>
			</div>
			<div class="col-lg-4 ">
				<div class="top-content">
					<ul class="list-inline quick-access">
						<li><a
							href="${pageContext.request.contextPath}/configuration/transaction/report/generate">
