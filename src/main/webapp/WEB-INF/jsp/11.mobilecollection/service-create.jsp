...
<html>
<head>
<title>MC Service DownTime | Create/Edit</title>
		...
		$(document).ready(function() {
			...
			$("#btn-save").click(function(){
                if ($("form").valid()) {
                    ...
                    submit('/mobilecollection/service/save', JSON.stringify(dataJson), function (data) {
		...
		<div class="row">
			<div class="col-lg-6 ">
				<div class="main-header">
					...
					<h3>
						<i class="fa fa-plus"></i> Create/Edit MC Service DownTime
					</h3>
