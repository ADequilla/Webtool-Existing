        ...
        $(document).ready(function() {
            ...
            $("#btn-save").click(function(){
                if ($("form").valid()) {
                    ...
                    submit('/mobilecollection/${REPORT_MENU}/save', JSON.stringify(dataJson), function (data) {
                    	if(data.id){
                    		document.location.href = '${pageContext.request.contextPath}/mobilecollection/${REPORT_MENU}/';
                    	}
	                });
                }
            });
							...
							<div class="form-body">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-2 control-label">Date Range <span
										...
										<div class="col-sm-4">
											...
											<div class="input-group">
												<input id="branchDesc" type="text" style="cursor: pointer;"
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select id="action" name="action" class="form-control">
												...
												<c:forEach items="${listMCActions}" var="lookup">
										...
										<div class="col-sm-4">
											<select id="application" name="application"
												...
												<c:forEach items="${listApplications}" var="lookup">
													<option value="${lookup.value}">${lookup.description}</option>
												</c:forEach>
											</select>
										</div>
									...
									<div class="form-group">
										<label class="col-md-2 control-label">Changes </label>
										<div class="col-sm-4">
											<select id="changes" name="changes" class="form-control">
												<option value="">-- Changes --</option>
												<c:forEach items="${listMCChanges}" var="lookup">
													<option value="${lookup.value}">${lookup.description}</option>
												</c:forEach>
											</select>
										</div>
