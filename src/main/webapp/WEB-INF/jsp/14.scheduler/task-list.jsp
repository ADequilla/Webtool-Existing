...
<script type="text/javascript">
        $(document).ready(function() {
        	...
        	var oTable = $("#dataTable").dataTable({
                "sAjaxSource"	: "${pageContext.request.contextPath}/scheduler/task/search",
                "sServerMethod"	: "GET",
                "bProcessing"	: false,
                "fnServerData"	: function (sSource, aoData, fnCallback) {
                	var taskID 				= $.trim($("#searchTaskId").val());
					var createdAt 	= $.trim($("#searchDateCreated").val());
					var taskName 	= $.trim($("#searchTaskName").val());
					
                    aoData.push({ "name": "taskID", "value": taskID });
                    aoData.push({ "name": "createdAt", "value": createdAt});
                    aoData.push({ "name": "taskName", "value": taskName });
                    jQuery.ajax({
                        "type"		: "GET",
                        "url"		: sSource,
                        "data"		: aoData,
			...
			<div class="col-lg-5 ">
				<div class="main-header">
					<ul class="breadcrumb">
						...
						<li>Scheduler</li>
						<li class="active"><a
							href="${pageContext.request.contextPath}/scheduler/task/">Task</a></li>
					</ul>
					<h3>
						<i class="fa fa-envelope"></i> Task
					</h3>
					<em>Scheduler</em>
				</div>
			</div>
		...
		<div class="main-content">
			...
			<div class="widget widget-table">
				...
				<div class="widget-content-search">
					...
					<div class="row">
						<div class="col-sm-6">
							<input type="text" placeholder="Task ID" id="searchTaskID"
								class="form-control">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<input type="text" placeholder="Task Name"
								id="searchTaskName" class="form-control">
						</div>
					</div>
						...
						<div class="col-sm-3">
							<div class="input-group">
								<input id="searchDateStart" style="cursor: pointer;" type="text"
									...
									placeholder="Created Date Start"> <span
						...
						<div class="col-sm-3">
							<div class="input-group">
								<input id="searchDateEnd" style="cursor: pointer;" type="text"
									...
									placeholder="Created Date End"> <span
									class="input-group-addon"><i class="fa fa-calendar"></i></span>
							</div>
						</div>
					</div>
			...
			<div class="widget widget-table">
				<div class="widget-header">
					<h3>
						<i class="fa fa-table"></i> List of Task
					</h3>
				</div>
