...
public class ServiceDownTimeController extends BaseController {

	final static String MENU 		= "UTILITIES";
	final static String PRIVILEDGE 	= "SERVICE_DOWNTIME";
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		return downTimeService.searchByMapCriteria(dataTables, searchMap, null);
	}
