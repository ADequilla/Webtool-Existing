...
@Controller
@RequestMapping("/dashboard/client-transaction")
public class DashboardClientTransactionController extends BaseController {

    final static String MENU 		= "DASHBOARD";
	final static String PRIVILEDGE 	= "CLIENT_TRANSACTION";
	private String BASE_VIEW 		= "13.dashboard/";
	// private String LIST_VIEW 		= "main-list";
    private String LIST_VIEW 		= "client-transaction";
    ...
    private void putIntoRequest(Model model) {
        model.addAttribute("CLIENT_TRANSACTION_REPORT", genericService.getConfigValueByName(ParamConfig.WEB_DASHBOARD_CLIENT_TRANSACTION));
