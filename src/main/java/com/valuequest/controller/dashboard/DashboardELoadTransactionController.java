...
@Controller
@RequestMapping("/dashboard/eload-transaction")
public class DashboardELoadTransactionController extends BaseController {

    final static String MENU 		= "DASHBOARD";
	final static String PRIVILEDGE 	= "ELOAD_TRANSACTION";
	private String BASE_VIEW 		= "13.dashboard/";
	// private String LIST_VIEW 		= "main-list";
    private String LIST_VIEW 		= "eload-transaction";
    ...
    private void putIntoRequest(Model model) {
        model.addAttribute("ELOAD_TRANSACTION_REPORT", genericService.getConfigValueByName(ParamConfig.WEB_DASHBOARD_ELOAD_TRANSACTION));
