...
public class ProductDenomController extends BaseController {
	...
	public @ResponseBody AjaxResponse delete(@RequestBody List<ProductDenomModel> states, HttpSession session, HttpServletResponse response) {
		response.setHeader("X-Frame-Options", "DENY");
	...
	public @ResponseBody AjaxResponse save(@RequestBody ProductDenomModel model, HttpSession session, HttpServletResponse response) {
		response.setHeader("X-Frame-Options", "DENY");
