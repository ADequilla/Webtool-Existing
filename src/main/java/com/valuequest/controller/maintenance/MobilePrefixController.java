...
public class MobilePrefixController extends BaseController {
	...
	public @ResponseBody AjaxResponse delete(@RequestBody List<MobilePrefixModel> states, HttpSession session, HttpServletResponse response) {
		response.setHeader("X-Frame-Options", "DENY");
	...
	public @ResponseBody AjaxResponse save(@RequestBody MobilePrefixModel model, HttpSession session, HttpServletResponse response) {
		response.setHeader("X-Frame-Options", "DENY");
