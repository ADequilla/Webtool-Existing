...
@Controller
@RequestMapping("/report/journals")
public class JournalsController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "JOURNALS";
	final static String RPT_MENU	= "journals";
	final static String RPT_TITLE 	= "Journals";
 ...
 response.setHeader("X-Frame-Options", "DENY");
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_JOURNALS);
	...
	public @ResponseBody AjaxResponse save(@RequestBody TransactionParam param, HttpSession session, HttpServletResponse response) {
		...
		report.setType(AsynReport.REPORT_TYPE_JOURNALS);
