...
@Controller
@RequestMapping("/report/mobile-collection-user-report")
public class MobileCollectionUserReportController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "MOBILE_COLLECTION_USER_REPORT";
	final static String RPT_MENU	= "mobile-collection-user-report";
	final static String RPT_TITLE 	= "Mobile Collection User Report";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-list";
	private String GENERATE_VIEW	= "param-mobile-collection-user-report";
 ...
 SecUser user = this.getLoginSecUser(session);
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_MOBILE_COLLECTION_USER);
	...
	public @ResponseBody AjaxResponse save(@RequestBody TransactionParam param, HttpSession session) {
		...
		String params = param.getTransDateStart() + "|" + 
						...
						param.getBranchCode() + "|" + 
					    param.getUnitCode() + "|END";

		AsynReport report = new AsynReport();
		report.setType(AsynReport.REPORT_TYPE_MOBILE_COLLECTION_USER);
