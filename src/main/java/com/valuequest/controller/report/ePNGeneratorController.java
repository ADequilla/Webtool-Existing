...
@Controller
@RequestMapping("/report/epn-generator-report")
public class ePNGeneratorController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "EPN_GENERATOR_REPORT";
	final static String RPT_MENU	= "epn-generator-report";
	final static String RPT_TITLE 	= "ePN Generator Report";
 ...
 SecUser user = this.getLoginSecUser(session);
	...
	public @ResponseBody AjaxResponse save(@RequestBody TransactionParam param, HttpSession session, HttpServletResponse response) {
		...
		report.setType(AsynReport.REPORT_TYPE_EPN_GENERATOR);
