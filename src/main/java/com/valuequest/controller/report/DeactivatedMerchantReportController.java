...
@Controller
@RequestMapping("/report/deactivated-merchant-report/")
public class DeactivatedMerchantReportController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "DEACTIVATED_MERCHANT_REPORT";
	final static String RPT_MENU	= "deactivated-merchant-report";
	final static String RPT_TITLE 	= "Deactivated Merchant Report";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-merchant-list";
	private String GENERATE_VIEW	= "param-merchant";
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_DEACTIVATED_MERCHANT);
	...
	public @ResponseBody AjaxResponse save(@RequestBody ReportParam param, HttpSession session) {
		...
		String params = param.getDateRangeStart() + "|" + 
						param.getDateRangeEnd() + "|END";
		
		params = params.replace("null", "");

		AsynReport report = new AsynReport();
		report.setType(AsynReport.REPORT_TYPE_DEACTIVATED_MERCHANT);
