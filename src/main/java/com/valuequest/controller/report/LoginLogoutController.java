...
public class LoginLogoutController extends BaseController {
	...
	final static String PRIVILEDGE 	= "LOGIN_LOGOUT";
	final static String RPT_MENU	= "login-logout";
	final static String RPT_TITLE 	= "Login - Logout Report";
 ...
 SecUser user = this.getLoginSecUser(session);
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_LOGIN_LOGOUT);
	...
	public @ResponseBody AjaxResponse save(@RequestBody ReportParam param, HttpSession session, HttpServletResponse response) {
		...
		report.setType(AsynReport.REPORT_TYPE_LOGIN_LOGOUT);
