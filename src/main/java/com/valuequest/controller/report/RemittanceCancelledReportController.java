...
@Controller
@RequestMapping("/report/remittance-cancelled-report")
public class RemittanceCancelledReportController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "REMITTANCE_CANCELLED_REPORT";
	final static String RPT_MENU	= "remittance-cancelled-report";
	final static String RPT_TITLE 	= "Remittance Cancelled Report";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-list";
	private String GENERATE_VIEW	= "param-remittance-cancelled-report";
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_REMITTANCE_CANCELLED);
	...
	public @ResponseBody AjaxResponse save(@RequestBody TransactionParam param, HttpSession session) {
		...
		String params = param.getTransDateStart() + "|" + 
					    ...
					    param.getTargetBranch() + "|END";

		AsynReport report = new AsynReport();
		report.setType(AsynReport.REPORT_TYPE_REMITTANCE_CANCELLED);
