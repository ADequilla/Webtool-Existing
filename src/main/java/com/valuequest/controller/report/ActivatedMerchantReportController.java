...
@Controller
@RequestMapping("/report/activated-merchant-report/")
public class ActivatedMerchantReportController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "ACTIVATED_MERCHANT_REPORT";
	final static String RPT_MENU	= "activated-merchant-report";
	final static String RPT_TITLE 	= "Activated Merchant Report";
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_ACTIVATED_MERCHANT);
	...
	public @ResponseBody AjaxResponse save(@RequestBody ReportParam param, HttpSession session) {
		...
		report.setType(AsynReport.REPORT_TYPE_ACTIVATED_MERCHANT);
