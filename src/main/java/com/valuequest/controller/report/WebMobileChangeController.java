...
@Controller
@RequestMapping("/report/mobile-change")
public class WebMobileChangeController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "WEB_MOBILE_CHANGE";
	final static String RPT_MENU	= "mobile-change";
	final static String RPT_TITLE 	= "Customer Change Mobile Number Report";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-list";
	private String GENERATE_VIEW	= "param-mobile-change";
 ...
 SecUser user = this.getLoginSecUser(session);
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_WEB_MOBILE_CHANGE);
	...
	public @ResponseBody AjaxResponse save(@RequestBody ReportParam param, HttpSession session) {
		...
		report.setType(AsynReport.REPORT_TYPE_WEB_MOBILE_CHANGE);
