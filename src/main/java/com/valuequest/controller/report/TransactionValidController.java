...
@Controller
@RequestMapping("/report/valid")
public class TransactionValidController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "TRANSACTION_VALID";
	final static String RPT_MENU	= "valid";
	final static String RPT_TITLE 	= "Valid Transaction Report";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-list";
	private String GENERATE_VIEW	= "param-valid";
 ...
 SecUser user = this.getLoginSecUser(session);
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_TRANS_VALID);
	...
	public @ResponseBody AjaxResponse save(@RequestBody TransactionParam param, HttpSession session) {
		...
		report.setType(AsynReport.REPORT_TYPE_TRANS_VALID);
