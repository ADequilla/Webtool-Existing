...
@Controller
@RequestMapping("/report/trans-report-ccm")
public class TransQrHistoryController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "REPORT_RECON_CCM";
	final static String RPT_MENU	= "trans-report-ccm";
	final static String RPT_TITLE 	= "Transaction Report Recon CCM";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-list";
	private String GENERATE_VIEW	= "param-recon-ccm";
 ...
 SecUser user = this.getLoginSecUser(session);
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_RECON_CCM);
	...
	public @ResponseBody AjaxResponse save(@RequestBody ReportParam param, HttpSession session) {
		...
		String params = param.getDateRangeStart() + "|" + 
						...
						param.getClientCid() + "|END";

		AsynReport report = new AsynReport();
		report.setType(AsynReport.REPORT_TYPE_RECON_CCM);
