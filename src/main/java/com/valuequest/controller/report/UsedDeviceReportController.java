...
@Controller
@RequestMapping("/report/list-used-device-report/")
public class UsedDeviceReportController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "LIST_USED_DEVICE_REPORT";
	final static String RPT_MENU	= "list-used-device-report";
	final static String RPT_TITLE 	= "Used Device ID Report";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-list";
	private String GENERATE_VIEW	= "param-used-device";
 ...
 SecUser user = this.getLoginSecUser(session);
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_USED_DEVICE);
	...
	public @ResponseBody AjaxResponse save(@RequestBody ReportParam param, HttpSession session, HttpServletResponse response) {
		...
		report.setType(AsynReport.REPORT_TYPE_USED_DEVICE);
