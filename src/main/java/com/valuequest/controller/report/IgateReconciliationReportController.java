...
@Controller
@RequestMapping("/report/igate-reconciliation-report")
public class IgateReconciliationReportController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "IGATE_RECONCILIATION_REPORT";
	final static String RPT_MENU	= "igate-reconciliation-report";
	final static String RPT_TITLE 	= "Igate Reconciliation Report";
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_IGATE_RECONCILIATION);
	...
	public @ResponseBody AjaxResponse save(@RequestBody ReportParam param, HttpSession session) {
		...
		report.setType(AsynReport.REPORT_TYPE_IGATE_RECONCILIATION);
