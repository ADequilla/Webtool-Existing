...
@Controller
@RequestMapping("/report/account-status-report")
public class AccountStatusReportController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "REPORT_ACCOUNT_STATUS";
	final static String RPT_MENU	= "account-status-report";
	final static String RPT_TITLE 	= "Account Status Report";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-list";
	private String GENERATE_VIEW	= "account-status-report";
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_ACCOUNT_STATUS_REPORT);
	...
	public @ResponseBody AjaxResponse save(@RequestBody ReportParam param, HttpSession session) {
		...
		report.setType(AsynReport.REPORT_TYPE_ACCOUNT_STATUS_REPORT);
