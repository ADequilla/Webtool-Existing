...
@Controller
@RequestMapping("/report/web-activity")
public class WebActivityController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "WEB_ACTIVITY";
	final static String RPT_MENU	= "web-activity";
	final static String RPT_TITLE 	= "User Activity Report";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-list";
	private String GENERATE_VIEW	= "param-web-activity";
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_WEB_ACTIVITY);
	...
	public @ResponseBody AjaxResponse save(@RequestBody ReportParam param, HttpSession session) {
		String params = param.getDateRangeStart() + "|" + 
						...
						param.getUsername() + "|" + 
						param.getDeviceId() + "|END";

		AsynReport report = new AsynReport();
		report.setType(AsynReport.REPORT_TYPE_WEB_ACTIVITY);
