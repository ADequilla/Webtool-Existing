...
@Controller
@RequestMapping("/report/failed-enrollment-list-report/")
public class FailedEnrollmentReportController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "FAILED_ENROLLMENT_LIST_REPORT";
	final static String RPT_MENU	= "failed-enrollment-list-report";
	final static String RPT_TITLE 	= "Failed Enrollment Report";
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_FAILED_ENROLLMENT);
