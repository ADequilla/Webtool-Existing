...
@Controller
@RequestMapping("/report/remittance-sent-report")
public class RemittanceSentReportController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "REMITTANCE_SENT_REPORT";
	final static String RPT_MENU	= "remittance-sent-report";
	final static String RPT_TITLE 	= "Remittance Sent Report";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-list";
	private String GENERATE_VIEW	= "param-remittance-sent-report";
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_REMITTANCE_SENT);
	...
	public @ResponseBody AjaxResponse save(@RequestBody TransactionParam param, HttpSession session) {
		...
		report.setType(AsynReport.REPORT_TYPE_REMITTANCE_SENT);
