...
@Controller
@RequestMapping("/report/remittance-claimed-report")
public class RemittanceClaimedReportController extends BaseController {

	final static String MENU 		= "REPORT";
	final static String PRIVILEDGE 	= "REMITTANCE_CLAIMED_REPORT";
	final static String RPT_MENU	= "remittance-claimed-report";
	final static String RPT_TITLE 	= "Remittance Claimed Report";
	private String BASE_VIEW 		= "08.report/";
	private String LIST_VIEW 		= "report-list";
	private String GENERATE_VIEW	= "param-remittance-claimed-report";
 ...
 SecUser user = this.getLoginSecUser(session);
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_REMITTANCE_CLAIMED);
	...
	public @ResponseBody AjaxResponse save(@RequestBody TransactionParam param, HttpSession session) {
		...
		report.setType(AsynReport.REPORT_TYPE_REMITTANCE_CLAIMED);
