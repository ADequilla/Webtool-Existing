...
public class TransactionController extends BaseController {
 ...
 SecUser user = this.getLoginSecUser(session);
	...
	public @ResponseBody DataTables search(DataTables dataTables, 
		...
		searchMap.put("type", AsynReport.REPORT_TYPE_K2C_TRANSACTION_REPORT);
	...
	public String generate(Model model, HttpSession session) {
		...
		if (getPriviledgeUser(session, PRIVILEDGE, NEW)) {
			...
			model.addAttribute("listK2CTransactionType", genericService.k2cTransactionTypeLookup(K2CTransactionTypeLookup.LOOKUP_K2C_TRANSACTION_LOG_TYPE));
