...
-- Sequence: seq_tmp_user_uploaded
DROP SEQUENCE IF EXISTS mfs.seq_tmp_user_uploaded CASCADE;
CREATE SEQUENCE mfs.seq_tmp_user_uploaded
	INCREMENT 1
	MINVALUE 1
	MAXVALUE 999999999999999999
	START 1
	CACHE 1;
ALTER TABLE mfs.seq_tmp_user_uploaded OWNER TO postgres;
...
CREATE TABLE mfs.log_audit_trail(
    LOG_AUDIT_ID            int8 NOT NULL,
    module_id		    int8,
    activity_name           varchar(50),
    cid                     varchar(30),
    activity_data_before    varchar(2048),
    activity_data_after     varchar(2048),
    app_type                varchar(10),
    created_by              int8,
    created_date            timestamp,
    CONSTRAINT "Pkey_log_audit_trail" PRIMARY KEY (LOG_AUDIT_ID) USING INDEX TABLESPACE cardbank_idx_tblspac 
)
;
...
-- 
-- TABLE: tmp_user_uploaded 
--
DROP TABLE IF EXISTS mfs.tmp_user_uploaded CASCADE;
CREATE TABLE mfs.tmp_user_uploaded(
	USER_ID		int8 NOT NULL,
	UPLOAD_ID	int8 NOT NULL,
	PHONE		varchar(15),
	CCID		varchar(50),
	...
	STATUS		varchar(10),
	MESSAGE		varchar(255),
	CONSTRAINT "PK_tmp_user_uploaded" PRIMARY KEY (USER_ID) USING INDEX TABLESPACE cardbank_idx_tblspac
)
;
